...
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || "https://telegra.ph/file/9a936ae2abc95e4bac05c.jpg Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    SESSION: (process.env.SESSION || process.env.SESSION_ID || 'Raganork~bc8e57bdf2705b2e156953e37d56acf0:4e2f314174594f394f75553d || '',
    IMGBB_KEY: ["76a050f031972d9f27e329d767dd988f", "deb80cd12ababea1c9b9a8ad6ce3fab2", "78c84c62b32a88e86daf87dd509a657a"],
    RG: process.env.RG || '919074309534-1632403322@g.us,120363116963909366@g.us',
    BOT_INFO: process.env.BOT_INFO || 'SHANI;MD994;0;https://telegra.ph/file/9a936ae2abc95e4bac05c.jpg',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "ꜛ-♥️⏤͟͟͞͞᚜ု᪳ₒ͞₃₄₅ᷤ₅ⷩ₁ⷶ₁ᷡ₆ͥ₉͞₉₄ှ᪳᚛͟͞⏤💍-↑",
    BOT_NAME: process.env.BOT_NAME || '*🅢𝐇𝐀𝐍𝐈 🅜𝐃⁹⁹⁴*',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'ꪶ͢٭𝑺𝜣𝑼𝑹𝛢𝑽𝑲𝑳¹¹ꫂ;SHANI MD bot;https://telegra.ph/file/9a936ae2abc95e4bac05c.jpg' : process.env.AUDIO_DATA,
    ...
    SUDO: process.env.SUDO || "923266565123",
